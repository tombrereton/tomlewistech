...
export default () => (
  <div className={styles.home}>
    ...
    <Service image={responsive} text={"Build you a fast and intuitive website. Optimised for both mobile and desktop."} />
    ...
    <Service image={responsive} text={"Design & Build complex software solutions where bespoke functionality is needed."} />
