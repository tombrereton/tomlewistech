      ...
      <div className={styles.pageWrapper}>
        <div className={styles.page}>
          <div className={styles.introSection}>
            ...
            <p className={styles.textBody}>I'm an Australian who enjoys strumming the guitar, cruising about on my skateboard and has a weakness for bacon & egg rolls on a Saturday morning.</p>
          </div>
